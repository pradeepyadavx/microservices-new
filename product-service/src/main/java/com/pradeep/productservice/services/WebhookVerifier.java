...
public class WebhookVerifier {
  ...
  public static boolean webhookIsVerified(String webhookBody, String signingKey, String nonce, String sig) throws Exception {
    Mac mac = Mac.getInstance(HMAC_SHA256_ALGORITHM);
    SecretKeySpec secretKey = new SecretKeySpec(signingKey.getBytes(), HMAC_SHA256_ALGORITHM);
    mac.init(secretKey);
    byte[] signatureBytes = mac.doFinal((nonce + "." + webhookBody).getBytes());
